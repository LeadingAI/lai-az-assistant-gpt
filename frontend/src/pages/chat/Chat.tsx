...
import Azure from "../../assets/pnat600.svg";
                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>People Services</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Ask People Services AI a question?</h2>
                            </Stack>
                        ) : (
